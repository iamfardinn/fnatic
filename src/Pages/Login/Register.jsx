  ...
  const img = e.target.img.value;
    ...
    return (
      ...
      <div
        ...
        style={{        backgroundImage: `url('https://i.ibb.co/p0H9Gkm/wallpaperflare-com-wallpaper-13.jpg')`,
        }}
      >
      ...
      <div className="hidden flex-col self-start text-white lg:flex">
         ...
         <p className="pr-3">
          ...
          <div className="z-10 flex justify-center self-center">          <div className="w-100 mx-auto rounded-2xl p-12">
         <div className="mb-4">
         ...
         <div className="space-y-2">
                  <label className="text-sm font-medium tracking-wide text-white">Name</label>
                  <input
